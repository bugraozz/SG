...
const Register = () => {
  ...
  const pwStrength = useMemo(() => {
    ...
    if (score <= 2) return { level: 1, label: 'Zayıf', class: 'weak' };
    if (score <= 3) return { level: 2, label: 'Orta', class: 'medium' };
    return { level: 3, label: 'Güçlü', class: 'strong' };
  }, [formData.password]);
        ...
        <div className="auth-decorative">
          ...
          <div className="auth-brand">
            ...
            <p className="auth-brand-desc">
              Binlerce sporcunun güvendiği platform. Hedeflerine 
              ulaşmak için hemen kaydol ve programına başla.
            </p>
          </div>
        </div>
        ...
        <div className="auth-form-panel">
          <div className="auth-form-header">
            <h1 className="auth-form-title">
              Kayıt <span className="highlight">Ol</span>
            </h1>
            <p className="auth-form-subtitle">
              Dönüşüm yolculuğuna ilk adımı at.
            </p>
          </div>
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
              ...
              <div className="auth-input-group">
                ...
                <div className="auth-input-wrapper">
                  <input
                    ...
                    required
                  />
                  <User className="auth-input-icon" style={{ pointerEvents: 'none' }} />
                </div>
              </div>
              <div className="auth-input-group">
            ...
            <div className="auth-input-group">
              ...
              <div className="auth-input-wrapper">
                <input
                  ...
                  autoComplete="tel"
                />
                <Phone className="auth-input-icon" style={{ pointerEvents: 'none' }} />
              </div>
            </div>
                ...
                <>
                  <div className="auth-pw-strength">
                    {[1, 2, 3].map((i) => (
                      <div
                        key={i}
                        className={`auth-pw-bar ${i <= pwStrength.level ? `active ${pwStrength.class}` : ''}`}
                      />
                    ))}
                  </div>
                  <span className={`auth-pw-label ${pwStrength.class}`}>
                    {pwStrength.label}
                  </span>
                </>
              )}
            ...
            <p className="auth-terms">
              ...
              <a href="#">Gizlilik Politikası</a>'nı kabul etmiş olursun.
            </p>
