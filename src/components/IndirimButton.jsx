...
import './IndirimButton.css';

const IndirimButton = () => {
  return (
    <div className="indirim-btn-wrapper" style={{ position: 'relative', display: 'inline-block' }}>
      <button className="indirim-btn">
        <div className="discount-badge">%10 İndirim</div>
        <div className="promo-code-badge">Kod: TEGMEN10</div>
        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              ...
              <span data-label="u" style={{ "--i": 4 }}>u</span>
              <span data-label="p" style={{ "--i": 5 }}>p</span>
              <span data-label="p" style={{ "--i": 6 }}>p</span>
              <span data-label="l" style={{ "--i": 7 }}>l</span>
              <span data-label="e" style={{ "--i": 8 }}>e</span>
              <span data-label="m" style={{ "--i": 9 }}>m</span>
              <span data-label="e" style={{ "--i": 10 }}>e</span>
              <span data-label="n" style={{ "--i": 11 }}>n</span>
              <span data-label="t" style={{ "--i": 12 }}>t</span>
            </span>
